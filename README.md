...
Defaults: `WHISPER_MODEL=large-v3`, `WHISPER_DEVICE=cuda`, `WHISPER_COMPUTE_TYPE=float16`, `VAD_MIN_SILENCE_MS=500`. Env always wins. If compute type is unset, a VRAM heuristic still applies:
